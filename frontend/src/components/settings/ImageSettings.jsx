...
/**
 * ImageSettings - Settings for image generation mode
 *
 * @param {Object} props
 ...
 * @param {boolean} props.sourceImage - Whether source image is provided (img2img)
 * @param {number} props.strength - Strength for img2img
 * @param {function} props.onStrengthChange - Callback for strength change
 * @param {boolean} props.upscaleAfterGeneration - Whether to upscale after generation
      ...
      <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
        ...
        <div className="flex items-center gap-2">
          ...
          <Switch
            ...
            onCheckedChange={onUpscaleAfterGenerationChange}
            disabled={isLoading || isUpscaling}
          />
        </div>
      </div>
